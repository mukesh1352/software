...
const TravelPage = () => {
  ...
  // Removed unused flightNumber variable
  ...
  return (
    <>
      ...
      {/* eslint-enable @next/next/google-font-display, @next/next/no-page-custom-font */}
                    ...
                    <div style={{ width: "60%" }}>
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            {passengerData.name.toUpperCase()}
                          </div>
                          <div
                            style={{
                              fontSize: "14px",
                          ...
                          >
                            Age: {passengerData.age} | Seat: {seatNumber}
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div style={{ width: "50%" }}>
                          ...
                          <div style={{ fontSize: "18px", fontWeight: "bold" }}>{formData.from}</div>
                          <div
                            style={{
                              fontSize: "16px",
                              color: "#d50000",
                        ...
                        <div style={{ width: "50%" }}>
                          ...
                          <div style={{ fontSize: "18px", fontWeight: "bold" }}>{formData.to}</div>
                          <div
                            style={{
                              fontSize: "16px",
                              color: "#d50000",
                      ...
                      >
                        <div>
                          ...
                          <div style={{ fontSize: "18px", fontWeight: "bold" }}>
                            AC {Math.floor(Math.random() * 9000) + 1000}
                          </div>
                        </div>
                        <div>
